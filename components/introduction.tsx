            ...
            <div className={styles.home} id="home">
                ...
                <div className={styles.flexItems}>
                    <div className={styles.buttonGroup}>
                        ...
                        <Link className={buttonVariants({ variant: "secondary" })} href="/cv-johan-gil.pdf" target="_blank">
                            <Paperclip className="mr-2" /> Download CV
                        </Link>
                    </div>
                </div>
                <Image src="/foto.jpg" alt="Johan Gil" width={180} height={180} className={styles.avatar} />
            </div>
